...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div>
            <div style="float: left; width: 260px; min-width: 260px; display: block;">
                ...
                <ul>
                    ...
                    <li><a id="aQuicKStartGuide" href="" class="selected" >Quick Start Guide</a></li>
    ...
    <script type="text/javascript">
        ...
        if (quickGuidesResults != "") {
            $("#contentDeatils").empty();
            $(quickGuidesResults).appendTo("#contentDeatils");
        }
