...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div style="padding-left: 10px; height: 40px; min-height: 40px; display: block">
            ...
            <img src="../../images/greyArrow.gif" alt="" />
            <a id="hypSelectPhone" href="/phones/index">
                <%= ViewData["phoneName"] %></a>
            <img src="../../images/greyArrow.gif" alt="" />
        ...
        <div>
            <div style="float: left; width: 260px; min-width: 260px; display: block;">
                ...
                <ul>
                    <li><a id="aMainFeatures" href="" class="selected" >Main Features</a></li>
                ...
                <div style="padding-top: 20px; padding-left: 24px">
                    <div style="border: solid 1px black; width: 139px">
                        <div style="text-align: center; padding-top: 20px">
                            <img id="imgPhone" src='<%= ViewData["phonephoto"] %>' style="height: 100px;
                                width: 100px; border-width: 0px;" /></div>
                        <div style="padding: 5px; text-align: center">
                            <span id="lblPhone" class="smallText"><%= ViewData["phoneName"] %></span></div>
                        <div style="padding-top: 15px;background-color:#000000;color:#ffffff;font-size:14px;">
                            <div style="margin-top: 8px;vertical-align:middle"><%=ViewData["Conclusion"] %> </div> 
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style="width: 424px; margin-left: 20px; margin-top: 10px">
                    ...
                    <div  style="height: 22px">
                        <label id="labSoftware" for="ddSoftware" class="text9">
                            Phone Software <%= Html.DropDownList("SoftwareVersions", (SelectList)(ViewData["PhoneSoftwareVersions"]), new { style = "width:75%;border:1px solid #125294;letter-spacing:0px;font-size:11px;", onchange = "fillResults(this.selectedIndex)" })%>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        var mainFeatureResults = '<%=ViewData["mainFeatures"]%>';
        //alert(mainFeatureResults);
        $("#overallCompatibility").empty();
        $(topFeatureResults).appendTo("#overallCompatibility");
        if (mainFeatureResults != "") {
            $("#detailedResults").empty();
            $(mainFeatureResults).appendTo("#detailedResults");
        }
